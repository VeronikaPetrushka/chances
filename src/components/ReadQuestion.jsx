    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.contentContainer}>
                ...
                <View style={{width: '100%', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24}}>
                    ...
                    <TouchableOpacity onPress={toggleFavorite}>
                        <Icon
                            image={isFavorite ? require('../assets/icons/favorite.png') : require('../assets/icons/not-favorite.png')}
                            width={24}
                            height={24}
                        />
                    </TouchableOpacity>
            ...
            <TouchableOpacity style={styles.editBtn} onPress={() => navigation.navigate('AddQuestionScreen', { item: item })}>
                <Image source={require('../assets/edit-btn.png')} style={{width: '100%', height: '100%', resizeMode: 'contain'}} />
            </TouchableOpacity>
